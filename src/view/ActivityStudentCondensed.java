...
public class ActivityStudentCondensed {
	...
	private void initialize() {
		...
		JToggleButton save1 = new JToggleButton("Save");
		GridBagConstraints gbc_save1 = new GridBagConstraints();
		gbc_save1.insets = new Insets(0, 0, 5, 5);
		gbc_save1.gridx = 2;
		gbc_save1.gridy = 1;
		tabulatedSubmissionsPanel.add(save1, gbc_save1);
		...
		JToggleButton toggleButton = new JToggleButton("Save");
		...
		tabulatedSubmissionsPanel.add(toggleButton, gbc_toggleButton);
		...
		JToggleButton toggleButton_1 = new JToggleButton("Save");
		...
		gbc_toggleButton_1.gridy = 3;
		tabulatedSubmissionsPanel.add(toggleButton_1, gbc_toggleButton_1);
		...
		JToggleButton toggleButton_2 = new JToggleButton("Save");
		...
		tabulatedSubmissionsPanel.add(toggleButton_2, gbc_toggleButton_2);
		...
		JToggleButton toggleButton_3 = new JToggleButton("Save");
		GridBagConstraints gbc_toggleButton_3 = new GridBagConstraints();
		gbc_toggleButton_3.insets = new Insets(0, 0, 0, 5);
		gbc_toggleButton_3.gridx = 2;
		gbc_toggleButton_3.gridy = 5;
		tabulatedSubmissionsPanel.add(toggleButton_3, gbc_toggleButton_3);
